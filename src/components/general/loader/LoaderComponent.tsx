...
// TODO: change the loader for the designed one
type TLoaderComponentProps = {
  hideText?: boolean
  pictureSize?: number
}
export const LoaderComponent = (props: TLoaderComponentProps) => {
  return (
    <div>
      <div className='flex-col items-center justify-center'>
        <div className='w-full max-w-[5rem] mx-auto'>
          <svg
            aria-hidden='true'
            style={{
